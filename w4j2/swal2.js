 ...
 * const {value: firstName} = await Swal({ ...textPromptOptions, title: 'What is first name?' })
 * const {value: lastName} = await Swal({ ...textPromptOptions, title: 'What is last name?' })
 *
 * After:
 * const TextPrompt = Swal.mixin({ input: 'text', showCancelButton: true })
 * const {value: firstName} = await TextPrompt('What is first name?')
 * const {value: lastName} = await TextPrompt('What is last name?')
 *
 * @param mixinParams
 */
